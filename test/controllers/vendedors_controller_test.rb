...
class VendedorsControllerTest < ActionController::TestCase
  ...
  test "should create vendedor" do
    assert_difference('Vendedor.count') do
      post :create, vendedor: { apellido: @vendedor.apellido, codigovendedor: @vendedor.codigovendedor, nombre: @vendedor.nombre }
    end
  ...
  test "should update vendedor" do
    patch :update, id: @vendedor, vendedor: { apellido: @vendedor.apellido, codigovendedor: @vendedor.codigovendedor, nombre: @vendedor.nombre }
    assert_redirected_to vendedor_path(assigns(:vendedor))
  end
