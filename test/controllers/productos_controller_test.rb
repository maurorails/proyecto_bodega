...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { cantidad: @producto.cantidad, descripcion: @producto.descripcion, fechaingreso: @producto.fechaingreso, sku: @producto.sku }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { cantidad: @producto.cantidad, descripcion: @producto.descripcion, fechaingreso: @producto.fechaingreso, sku: @producto.sku }
    assert_redirected_to producto_path(assigns(:producto))
  end
